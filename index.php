...
<?php
	require_once("DBController.php");//tham chieu thu vien
	$db_handle = new DBController();//tao 1 doi tuong DB moi
	$comments = $db_handle->runQuery("SELECT * FROM comment");//lay du lieu tu bang comment
?>
